...
data class Update(
    ...
    companion object {
        fun fromApp(context: Context, app: App, isIncompatible: Boolean = false): Update = Update(
            ...
            hasValidCert = if (com.aurora.gplayapi.PatchedAppManager.isPatchedApp(app.packageName)) {
                true
            } else {
            ...
            fileList = app.fileList.filterNot { it.url.isBlank() },
            sharedLibs = app.dependencies.dependentLibraries.map { SharedLib.fromApp(it) },
